<x-filament-user-profile::section-table :aside="true">
    <x-slot name="heading">
        {{ __('filament-user-profile::default.profile.sanctum.title') }}
    </x-slot>

    <x-slot name="description">
        {{ __('filament-user-profile::default.profile.sanctum.description') }}
    </x-slot>
        ...
        @if ($plainTextToken)
            <div
                ...
                <div class="fi-section-content space-y-2 bg-warning-500 p-6 rounded">
                    <p class="text-sm">{{ __('filament-user-profile::default.profile.sanctum.create.message') }}</p>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="inline-block text-xs">
                            <x-filament-user-profile::clipboard-link :data="$plainTextToken" />
                        </div>
                        <x-filament::button icon="heroicon-s-clipboard-document-check" size="sm" type="button"
                            wire:click="$set('plainTextToken',null)">{{ __('filament-user-profile::default.profile.sanctum.copied.label') }}
                        </x-filament::button>
                    </div>
...
</x-filament-user-profile::section-table>
